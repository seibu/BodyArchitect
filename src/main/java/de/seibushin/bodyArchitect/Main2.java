...
import de.seibushin.bodyArchitect.views.PrimaryView;
import de.seibushin.bodyArchitect.views.SecondaryView;
...
public class Main2 extends MobileApplication {
    ...
    public void init() {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Gluon Mobile",
                "Multi View Project",
                new Avatar(21, new Image(Main2.class.getResourceAsStream("/icon.png"))));
    ...
    public void postInit(Scene scene) {
        ...
        scene.getStylesheets().add(Main2.class.getResource("style.css").toExternalForm());
        ((Stage) scene.getWindow()).getIcons().add(new Image(Main2.class.getResourceAsStream("/icon.png")));
    }
}
